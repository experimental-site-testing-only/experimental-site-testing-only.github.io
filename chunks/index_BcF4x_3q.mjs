const id = "Previous Versions/v0_6_8/Getting Started/index.mdx";
						const collection = "docs";
						const slug = "previous-versions/v0_6_8/getting-started";
						...
						const data = {title:"What Is C3?",description:"A guide to the C3 Programming Language",editUrl:true,head:[],template:"doc",sidebar:{order:1,hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/josh/git/c3_tests/experimental-site-testing-only__local_changes/src/content/docs/Previous Versions/v0_6_8/Getting Started/index.mdx",
							rawData: undefined,
						};
