const id = "FAQ/rejected-ideas.md";
						const collection = "docs";
						const slug = "faq/rejected-ideas";
						...
						const _internal = {
							type: 'content',
							filePath: "/home/josh/git/c3_tests/experimental-site-testing-only__local_changes/src/content/docs/FAQ/rejected-ideas.md",
							rawData: undefined,
						};
