const id = "Generic Programming/generics.md";
						const collection = "docs";
						const slug = "generic-programming/generics";
						...
						const _internal = {
							type: 'content',
							filePath: "/home/josh/git/c3_tests/experimental-site-testing-only__local_changes/src/content/docs/Generic Programming/generics.md",
							rawData: undefined,
						};
