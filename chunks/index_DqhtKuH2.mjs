const id = "Get Involved/index.md";
						...
						const data = {title:"Community & Contribute",description:"Info regarding the development of C3",editUrl:true,head:[],template:"doc",sidebar:{order:10,hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/josh/git/c3_tests/experimental-site-testing-only__local_changes/src/content/docs/Get Involved/index.md",
							rawData: undefined,
						};
