const id = "Previous Versions/v0_6_8/Language Fundamentals/variables.md";
						const collection = "docs";
						const slug = "previous-versions/v0_6_8/language-fundamentals/variables";
						...
						const _internal = {
							type: 'content',
							filePath: "/home/josh/git/c3_tests/experimental-site-testing-only__local_changes/src/content/docs/Previous Versions/v0_6_8/Language Fundamentals/variables.md",
							rawData: undefined,
						};
