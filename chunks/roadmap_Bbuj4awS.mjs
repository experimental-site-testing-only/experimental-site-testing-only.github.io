const id = "Getting Started/roadmap.md";
						const collection = "docs";
						const slug = "getting-started/roadmap";
						...
						const data = {title:"Roadmap For C3",description:"Roadmap For C3",editUrl:true,head:[],template:"doc",sidebar:{order:3,hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/josh/git/c3_tests/experimental-site-testing-only__local_changes/src/content/docs/Getting Started/roadmap.md",
							rawData: undefined,
						};
